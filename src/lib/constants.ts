// ─── Brand Colours (Lighter & Brighter) ───
export const colors = {
  bg: '#FAFAF8',
  bgAlt: '#F5F0EB',
  gold: '#c9956b',
...
export const eventTypes = [
  { slug: 'weddings', name: 'Weddings', icon: '💍', description: 'Make your big day unforgettable with a premium bar experience your guests will rave about.' },
  { slug: 'corporate', name: 'Corporate Events', icon: '🏢', description: 'Impress clients and reward teams with polished, professional bar service.' },
  { slug: 'birthday-parties', name: 'Birthday Parties', icon: '🎂', description: 'Celebrate in style with cocktails, mocktails, and a setup that wows.' },
  { slug: 'garden-parties', name: 'Garden Parties', icon: '🌿', description: 'Al fresco drinks done right — beautiful bars for outdoor entertaining.' },
  { slug: 'festivals', name: 'Festivals', icon: '🎵', description: 'High-volume, high-energy bar setups built for festival crowds.' },
  { slug: 'christmas', name: 'Christmas Parties', icon: '🎄', description: 'Festive cocktails, winter warmers, and party vibes to see out the year.' },
];
...
export const quoteConfig = {
  serviceMultipliers: {
    'all-inclusive': { perHead: 29.9, base: 0 },
    'cash-bar': { perHead: 0, base: 395 },
    'dry-hire': { perHead: 0, base: 295 },
    'staff-only': { perHead: 0, base: 200 },
  },
  barPrices: {
    '5ft': 295,
    '10ft': 395,
  ...
  extras: [
    { id: 'glassware', name: 'Premium Glassware Upgrade', price: 150 },
    { id: 'cocktail-menu', name: 'Signature Cocktail Menu', price: 200 },
    { id: 'branded-panels', name: 'Branded Bar Panels', price: 350 },
    { id: 'late-night', name: 'Late Night Service (+2hrs)', price: 300 },
  ],
} as const;
